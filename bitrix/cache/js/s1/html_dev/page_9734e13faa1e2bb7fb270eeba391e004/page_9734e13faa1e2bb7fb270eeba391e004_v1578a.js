...
; /* Start:"a:4:{s:4:"full";s:57:"/local/components/db.base/form/js/form.js?149060301110194";s:6:"source";s:41:"/local/components/db.base/form/js/form.js";s:3:"min";s:0:"";s:3:"map";s:0:"";}"*/
var ShefFormSimple = {
...
/* End */
;
; /* Start:"a:4:{s:4:"full";s:72:"/local/templates/html_dev/js/libs/jquery.validate.min.js?149398880421401";s:6:"source";s:56:"/local/templates/html_dev/js/libs/jquery.validate.min.js";s:3:"min";s:0:"";s:3:"map";s:0:"";}"*/
...
/* End */
;
; /* Start:"a:4:{s:4:"full";s:73:"/local/templates/html_dev/js/libs/jquery.validate_ru.min.js?1493988804997";s:6:"source";s:59:"/local/templates/html_dev/js/libs/jquery.validate_ru.min.js";s:3:"min";s:0:"";s:3:"map";s:0:"";}"*/
$.validator.messages={required:"Заполните поле",remote:"Исправьте поля",email:"Некорректный e-mail",url:"Введите корректный URL",date:"Введите правильную дату",dateISO:"Введите правильную дату ( ISO )",number:"Введите корректный номер",digits:"Введите только цифры",creditcard:"Введите корректный номер кредитной карты",equalTo:"Поля не совпадают",maxlength:$.validator.format("Максимум {0} символов"),minlength:$.validator.format("Минимум {0} символов"),rangelength:$.validator.format("Введите значение длиной от {0} до {1} символов"),range:$.validator.format("Введите значение между {0} и {1}"),max:$.validator.format("Минимум {0} символов"),min:$.validator.format("Максимум {0} символов")};
/* End */
;; /* /local/components/db.base/form/js/form.js?149060301110194*/
; /* /local/templates/html_dev/js/libs/jquery.validate.min.js?149398880421401*/
; /* /local/templates/html_dev/js/libs/jquery.validate_ru.min.js?1493988804997*/
